    ...
    public function run(): void
    {
        DB::table('services')->insert([
            [
                ...
                'image_path' => '/img/service__img/lips_card.jpg',
            ...
            [
                ...
                'image_path' => '/img/service__img/face_card.jpg',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                ...
                'image_path' => '/img/service__img/body_card.jpg',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                ...
                'image_path' => '/img/service__img/meza_card.jpg',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
        ]);
