...
<div class="admin__content">
    ...
    <form action="{{ route('crm.articles.update', $article) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-group mb-3">
            ...
            <input type="date" class="form-control" id="published_at" name="published_at" value="{{ old('published_at', $article->published_at ? $article->published_at->format('Y-m-d') : '') }}">
        </div>
        
        <div class="form-group">
            <button type="submit" class="admin__btn">Обновить статью</button>
