<div class="crm-cards-list">
    @foreach($services as $service)
        <div class="crm-card">
            ...
            <div class="crm-card__row"><span class="crm-card__label">Картинка</span><span class="crm-card__value"><img src="{{ $service->image_path }}" alt="" class="crm-card__img"></span></div>
